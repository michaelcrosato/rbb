...
Version 0.3 uses network protocol 2. Upgrade the static client and dedicated server together. Save v1 migrates to v2 while preserving the existing island and progress; take the normal stopped-server backup before upgrading a persistent deployment.
